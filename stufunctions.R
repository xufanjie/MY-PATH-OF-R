...
# To clean the dataframe. 'n' is the number of rows the dataframe is suppose to have.
# If 'createheader' is true, the messy dataframe falsely contains header in its content.
